...
C     
C     Process: u u~ > piu23due piu23due~ WEIGHTED<=2 @1
C     *   Decay: piu23due > vm~ c WEIGHTED<=1
C     *   Decay: piu23due~ > vm c~ WEIGHTED<=1
C     Process: d d~ > piu23due piu23due~ WEIGHTED<=2 @1
C     *   Decay: piu23due > vm~ c WEIGHTED<=1
C     *   Decay: piu23due~ > vm c~ WEIGHTED<=1
C     Process: s s~ > piu23due piu23due~ WEIGHTED<=2 @1
C     *   Decay: piu23due > vm~ c WEIGHTED<=1
C     *   Decay: piu23due~ > vm c~ WEIGHTED<=1
C     Process: b b~ > piu23due piu23due~ WEIGHTED<=2 @1
C     *   Decay: piu23due > vm~ c WEIGHTED<=1
C     *   Decay: piu23due~ > vm c~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
