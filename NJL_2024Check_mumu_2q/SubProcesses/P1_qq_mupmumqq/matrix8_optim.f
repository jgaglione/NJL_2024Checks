...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPid23due)
      ...
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,3)) ! count 3
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,4)) ! count 3
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,5)) ! count 5
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,6)) ! count 5
      CALL OXXXXX(P(0,5),ZERO,+1,+1*IC(5),W(1,7)) ! count 1
      ...
      CALL FFS2_3(W(1,1),W(1,5),GC_62,MDL_MASSB, ZERO,W(1,11)) ! count 6
      CALL FFS2_3(W(1,1),W(1,6),GC_62,MDL_MASSB, ZERO,W(1,12)) ! count 6
      CALL FFV1P0_3(W(1,9),W(1,8),GC_16,ZERO, FK_ZERO,W(1,13)) ! count 9
      CALL FFV1P0_3(W(1,10),W(1,7),GC_16,ZERO, FK_ZERO,W(1,14)) ! count 9
      CALL FFS1_2(W(1,3),W(1,11),GC_62,ZERO, FK_ZERO,W(1,15)) ! count 2
      CALL FFS1_2(W(1,3),W(1,12),GC_62,ZERO, FK_ZERO,W(1,16)) ! count 2
      CALL FFS1_2(W(1,4),W(1,11),GC_62,ZERO, FK_ZERO,W(1,17)) ! count 2
      CALL FFS1_2(W(1,4),W(1,12),GC_62,ZERO, FK_ZERO,W(1,18)) ! count 2
      CALL FFV1P1N_1(W(1,2), W(1,13), GC_16, TMP(1))
      call CombineAmp(4,
     & (/3,1,7,5/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,2), W(1,14), GC_16, TMP(1))
      call CombineAmp(4,
     & (/4,2,8,6/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFS1_3(W(1,3),W(1,2),GC_62,MDL_MASSB, ZERO,W(1,19)) ! count 8
      CALL FFS1_3(W(1,4),W(1,2),GC_62,MDL_MASSB, ZERO,W(1,20)) ! count 8
     ...
     & TMP, W, AMP(1,2)) ! count 1
      ...
      CALL FFS2P1N_1(W(1,5), W(1,19), GC_62, TMP(1))
      call CombineAmp(2,
     & (/3,4/), 
     & (/38,39/),
     & TMP, W, AMP(1,8))
      CALL FFS2P1N_1(W(1,5), W(1,20), GC_62, TMP(1))
      call CombineAmp(2,
     & (/7,8/), 
     & (/38,39/),
     & TMP, W, AMP(1,8))
