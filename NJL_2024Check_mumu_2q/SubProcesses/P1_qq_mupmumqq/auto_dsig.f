...
C     Process: c c~ > mu+ mu- c c~ WEIGHTED<=4 @1
C     Process: s s > mu+ mu- s s WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- s s~ WEIGHTED<=4 @1
C     Process: c~ c~ > mu+ mu- c~ c~ WEIGHTED<=4 @1
C     Process: s~ s~ > mu+ mu- s~ s~ WEIGHTED<=4 @1
C     Process: c s > mu+ mu- c s WEIGHTED<=4 @1
C     Process: c c~ > mu+ mu- s s~ WEIGHTED<=4 @1
C     Process: c s~ > mu+ mu- c s~ WEIGHTED<=4 @1
C     Process: s c~ > mu+ mu- s c~ WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- c c~ WEIGHTED<=4 @1
C     Process: c~ s~ > mu+ mu- c~ s~ WEIGHTED<=4 @1
C     Process: u c > mu+ mu- u c WEIGHTED<=4 @1
C     Process: u s > mu+ mu- u s WEIGHTED<=4 @1
C     Process: d s > mu+ mu- d s WEIGHTED<=4 @1
C     Process: u u~ > mu+ mu- c c~ WEIGHTED<=4 @1
C     Process: d d~ > mu+ mu- c c~ WEIGHTED<=4 @1
C     Process: b b~ > mu+ mu- c c~ WEIGHTED<=4 @1
C     Process: u u~ > mu+ mu- s s~ WEIGHTED<=4 @1
C     Process: d d~ > mu+ mu- s s~ WEIGHTED<=4 @1
C     Process: b b~ > mu+ mu- s s~ WEIGHTED<=4 @1
C     Process: u c~ > mu+ mu- u c~ WEIGHTED<=4 @1
C     Process: d c~ > mu+ mu- d c~ WEIGHTED<=4 @1
C     Process: b c~ > mu+ mu- b c~ WEIGHTED<=4 @1
C     Process: u s~ > mu+ mu- u s~ WEIGHTED<=4 @1
C     Process: d s~ > mu+ mu- d s~ WEIGHTED<=4 @1
C     Process: b s~ > mu+ mu- b s~ WEIGHTED<=4 @1
C     Process: c d > mu+ mu- c d WEIGHTED<=4 @1
C     Process: c b > mu+ mu- c b WEIGHTED<=4 @1
C     Process: c u~ > mu+ mu- c u~ WEIGHTED<=4 @1
C     Process: c d~ > mu+ mu- c d~ WEIGHTED<=4 @1
C     Process: c b~ > mu+ mu- c b~ WEIGHTED<=4 @1
C     Process: c c~ > mu+ mu- u u~ WEIGHTED<=4 @1
C     Process: c c~ > mu+ mu- d d~ WEIGHTED<=4 @1
C     Process: c c~ > mu+ mu- b b~ WEIGHTED<=4 @1
C     Process: s b > mu+ mu- s b WEIGHTED<=4 @1
C     Process: s u~ > mu+ mu- s u~ WEIGHTED<=4 @1
C     Process: s d~ > mu+ mu- s d~ WEIGHTED<=4 @1
C     Process: s b~ > mu+ mu- s b~ WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- u u~ WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- d d~ WEIGHTED<=4 @1
C     Process: s s~ > mu+ mu- b b~ WEIGHTED<=4 @1
C     Process: u~ c~ > mu+ mu- u~ c~ WEIGHTED<=4 @1
C     Process: u~ s~ > mu+ mu- u~ s~ WEIGHTED<=4 @1
C     Process: d~ s~ > mu+ mu- d~ s~ WEIGHTED<=4 @1
C     Process: c~ d~ > mu+ mu- c~ d~ WEIGHTED<=4 @1
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! c c > mu+ mu- c c
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! c c~ > mu+ mu- c c~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! s s > mu+ mu- s s
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! s s~ > mu+ mu- s s~
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! c~ c~ > mu+ mu- c~ c~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! s~ s~ > mu+ mu- s~ s~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! c s > mu+ mu- c s
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! c c~ > mu+ mu- s s~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! c s~ > mu+ mu- c s~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! s c~ > mu+ mu- s c~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! s s~ > mu+ mu- c c~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! c~ s~ > mu+ mu- c~ s~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u c > mu+ mu- u c
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u s > mu+ mu- u s
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u u~ > mu+ mu- c c~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! u u~ > mu+ mu- s s~
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! u c~ > mu+ mu- u c~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! u s~ > mu+ mu- u s~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! c d > mu+ mu- c d
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! c u~ > mu+ mu- c u~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! c c~ > mu+ mu- u u~
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! s b > mu+ mu- s b
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! s u~ > mu+ mu- s u~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! s s~ > mu+ mu- u u~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! u~ c~ > mu+ mu- u~ c~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! u~ s~ > mu+ mu- u~ s~
        IF(IPROC.EQ.27) DSIGPROC=DSIG27(P1,WGT,IMODE)  ! c~ d~ > mu+ mu- c~ d~
        IF(IPROC.EQ.28) DSIGPROC=DSIG28(P1,WGT,IMODE)  ! s~ b~ > mu+ mu- s~ b~
      ENDIF
