...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPid23due)
      ...
      CALL FFS2_3(W(1,10),W(1,6),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,11)) ! count 6
      CALL FFS2_3(W(1,10),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,12)) ! count 6
      CALL FFV1P0_3(W(1,1),W(1,8),GC_16,ZERO, FK_ZERO,W(1,13)) ! count 9
      CALL FFV1P0_3(W(1,2),W(1,9),GC_16,ZERO, FK_ZERO,W(1,14)) ! count 9
      ...
      CALL FFV1P1N_1(W(1,3), W(1,13), GC_16, TMP(1))
      call CombineAmp(4,
     & (/2,1,4,3/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1))
      CALL FFV1P1N_1(W(1,3), W(1,14), GC_16, TMP(1))
      call CombineAmp(4,
     & (/6,5,8,7/), 
     & (/15,16,17,18/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFS1_3(W(1,4),W(1,3),GC_62,MDL_MASSB, ZERO,W(1,19)) ! count 8
      CALL FFS1_3(W(1,5),W(1,3),GC_62,MDL_MASSB, ZERO,W(1,20)) ! count 8
