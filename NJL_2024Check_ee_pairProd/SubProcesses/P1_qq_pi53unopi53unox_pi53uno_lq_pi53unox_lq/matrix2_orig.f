...
C     
C     Process: c c~ > pi53uno pi53uno~ WEIGHTED<=2 @1
C     *   Decay: pi53uno > e+ u WEIGHTED<=1
C     *   Decay: pi53uno~ > e- u~ WEIGHTED<=1
C     Process: d d~ > pi53uno pi53uno~ WEIGHTED<=2 @1
C     *   Decay: pi53uno > e+ u WEIGHTED<=1
C     *   Decay: pi53uno~ > e- u~ WEIGHTED<=1
C     Process: s s~ > pi53uno pi53uno~ WEIGHTED<=2 @1
C     *   Decay: pi53uno > e+ u WEIGHTED<=1
C     *   Decay: pi53uno~ > e- u~ WEIGHTED<=1
C     Process: b b~ > pi53uno pi53uno~ WEIGHTED<=2 @1
C     *   Decay: pi53uno > e+ u WEIGHTED<=1
C     *   Decay: pi53uno~ > e- u~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
