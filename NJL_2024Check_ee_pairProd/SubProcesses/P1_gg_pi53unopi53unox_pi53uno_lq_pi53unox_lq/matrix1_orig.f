...
C     
C     Process: g g > pi53uno pi53uno~ WEIGHTED<=2 @1
C     *   Decay: pi53uno > e+ u WEIGHTED<=1
C     *   Decay: pi53uno~ > e- u~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPI53UNO)
      ...
      CALL FFS1_3(W(1,3),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53UNO,W(1,5)
     $ )
      CALL OXXXXX(P(0,5),ZERO,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),ZERO,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS2_3(W(1,3),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53UNO,W(1,6)
     $ )
