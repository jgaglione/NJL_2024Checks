...
C     
C     Process: g b~ > pid23tre~ ta+ WEIGHTED<=2 @2
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPID23TRE)
      ...
      CALL FFS2_3(W(1,4),W(1,3),GC_63,MDL_MASSB, FK_MDL_WPID23TRE,W(1
     $ ,5))
      CALL IXXXXX(P(0,5),MDL_MTA,NHEL(5),-1*IC(5),W(1,4))
      CALL FFV1_1(W(1,2),W(1,1),GC_16,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,4),W(1,3),W(1,5),GC_63,AMP(1))
      CALL VSS1_3(W(1,1),W(1,5),GC_15,MDL_MASSB, ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,4),W(1,2),W(1,3),GC_63,AMP(2))
