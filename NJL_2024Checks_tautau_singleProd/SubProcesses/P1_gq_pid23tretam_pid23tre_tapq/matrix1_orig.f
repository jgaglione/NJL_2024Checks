...
C     
C     Process: g b > pid23tre ta- WEIGHTED<=2 @1
...
C     ----------
     ...
     $ ,5))
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_16,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL FFS2_0(W(1,3),W(1,4),W(1,5),GC_63,AMP(1))
      CALL VSS1_2(W(1,1),W(1,5),GC_15,MDL_MASSB, ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS2_0(W(1,2),W(1,4),W(1,3),GC_63,AMP(2))
