...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPID23TRE)
      ...
      CALL FFV1P0_3(W(1,6),W(1,2),GC_16,ZERO, FK_ZERO,W(1,8))
      CALL FFS1_2(W(1,3),W(1,7),GC_63,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,5),W(1,8),GC_16,AMP(1))
      CALL FFS1_3(W(1,3),W(1,5),GC_63,MDL_MASSB, FK_MDL_WPID23TRE,W(1
     $ ,10))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,8),W(1,7),W(1,10),GC_15,AMP(2))
      CALL FFV1P0_3(W(1,6),W(1,5),GC_16,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,9),W(1,2),W(1,11),GC_16,AMP(3))
      CALL FFS1_3(W(1,3),W(1,2),GC_63,MDL_MASSB, ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1P0_3(W(1,1),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12))
      CALL FFS2_3(W(1,6),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23TRE,W(1
     $ ,7))
      CALL FFV1_1(W(1,5),W(1,12),GC_16,ZERO, FK_ZERO,W(1,13))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV1P0_3(W(1,1),W(1,5),GC_16,ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,2),W(1,13),GC_16,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 13
      CALL FFS1_0(W(1,12),W(1,5),W(1,7),GC_63,AMP(13))
      CALL FFS2_2(W(1,1),W(1,10),GC_63,MDL_MTA, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 14
      CALL FFS1_0(W(1,12),W(1,2),W(1,7),GC_63,AMP(14))
