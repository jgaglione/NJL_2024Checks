...
C     Process: b b~ > ta+ ta- b b~ WEIGHTED<=4 @1
C     Process: b~ b~ > ta+ ta- b~ b~ WEIGHTED<=4 @1
C     Process: u b > ta+ ta- u b WEIGHTED<=4 @1
C     Process: c b > ta+ ta- c b WEIGHTED<=4 @1
C     Process: d b > ta+ ta- d b WEIGHTED<=4 @1
C     Process: s b > ta+ ta- s b WEIGHTED<=4 @1
...
C     Process: d b~ > ta+ ta- d b~ WEIGHTED<=4 @1
C     Process: s b~ > ta+ ta- s b~ WEIGHTED<=4 @1
C     Process: b u~ > ta+ ta- b u~ WEIGHTED<=4 @1
C     Process: b c~ > ta+ ta- b c~ WEIGHTED<=4 @1
C     Process: b d~ > ta+ ta- b d~ WEIGHTED<=4 @1
C     Process: b s~ > ta+ ta- b s~ WEIGHTED<=4 @1
C     Process: b b~ > ta+ ta- u u~ WEIGHTED<=4 @1
C     Process: b b~ > ta+ ta- c c~ WEIGHTED<=4 @1
C     Process: b b~ > ta+ ta- d d~ WEIGHTED<=4 @1
C     Process: b b~ > ta+ ta- s s~ WEIGHTED<=4 @1
C     Process: u~ b~ > ta+ ta- u~ b~ WEIGHTED<=4 @1
C     Process: c~ b~ > ta+ ta- c~ b~ WEIGHTED<=4 @1
C     Process: d~ b~ > ta+ ta- d~ b~ WEIGHTED<=4 @1
C     Process: s~ b~ > ta+ ta- s~ b~ WEIGHTED<=4 @1
...
C       Output weights and number of events
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(18E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        SUMPROB=0D0
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(18E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(18I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        ENDIF
        IF(IPROC.EQ.1) DSIGPROC=DSIG1(P1,WGT,IMODE)  ! b b > ta+ ta- b b
        IF(IPROC.EQ.2) DSIGPROC=DSIG2(P1,WGT,IMODE)  ! b b~ > ta+ ta- b b~
        IF(IPROC.EQ.3) DSIGPROC=DSIG3(P1,WGT,IMODE)  ! b~ b~ > ta+ ta- b~ b~
        IF(IPROC.EQ.4) DSIGPROC=DSIG4(P1,WGT,IMODE)  ! u b > ta+ ta- u b
        IF(IPROC.EQ.5) DSIGPROC=DSIG5(P1,WGT,IMODE)  ! u u~ > ta+ ta- b b~
        IF(IPROC.EQ.6) DSIGPROC=DSIG6(P1,WGT,IMODE)  ! u b~ > ta+ ta- u b~
        IF(IPROC.EQ.7) DSIGPROC=DSIG7(P1,WGT,IMODE)  ! b u~ > ta+ ta- b u~
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! b b~ > ta+ ta- u u~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u~ b~ > ta+ ta- u~ b~
      ENDIF
