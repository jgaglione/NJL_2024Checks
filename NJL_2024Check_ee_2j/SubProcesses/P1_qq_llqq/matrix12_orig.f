...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFS1_1(W(1,1),W(1,7),GC_62,ZERO, FK_ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 4
      CALL FFS1_0(W(1,3),W(1,7),W(1,1),GC_63,AMP(4))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFS2_2(W(1,5),W(1,9),GC_62,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFS1_0(W(1,7),W(1,2),W(1,1),GC_63,AMP(7))
