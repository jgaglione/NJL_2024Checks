...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFS1_1(W(1,5),W(1,7),GC_62,ZERO, FK_ZERO,W(1,11))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,6),W(1,11),W(1,10),GC_63,AMP(3))
      CALL FFV1P0_3(W(1,1),W(1,5),GC_16,ZERO, FK_ZERO,W(1,11))
      CALL FFS2_3(W(1,6),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23UNO,W(1
     $ ,5))
      CALL FFV1_1(W(1,2),W(1,11),GC_16,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 4
      CALL FFS1_0(W(1,3),W(1,7),W(1,5),GC_63,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VSS1_0(W(1,11),W(1,5),W(1,10),GC_15,AMP(5))
      CALL FFV1_2(W(1,6),W(1,11),GC_16,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,7),W(1,4),W(1,10),GC_63,AMP(6))
      CALL FFS2_2(W(1,1),W(1,9),GC_62,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 7
      CALL FFS1_0(W(1,7),W(1,2),W(1,5),GC_63,AMP(7))
      CALL FFV1_2(W(1,1),W(1,8),GC_16,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 8
      CALL FFS2_0(W(1,7),W(1,4),W(1,9),GC_62,AMP(8))
C     JAMPs contributing to orders ALL_ORDERS=1
      ...
      JAMP(2,1) = AMP(3)+AMP(7)+(1.666666666666667D-01)*TMP_JAMP(5)
