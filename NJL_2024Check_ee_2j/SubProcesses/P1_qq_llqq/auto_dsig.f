...
C     Process: u~ u~ > e+ e- u~ u~ WEIGHTED<=4 @1
C     Process: d~ d~ > e+ e- d~ d~ WEIGHTED<=4 @1
C     Process: u d > e+ e- u d WEIGHTED<=4 @1
C     Process: u u~ > e+ e- d d~ WEIGHTED<=4 @1
C     Process: u d~ > e+ e- u d~ WEIGHTED<=4 @1
C     Process: d u~ > e+ e- d u~ WEIGHTED<=4 @1
C     Process: d d~ > e+ e- u u~ WEIGHTED<=4 @1
C     Process: u~ d~ > e+ e- u~ d~ WEIGHTED<=4 @1
C     Process: u c > e+ e- u c WEIGHTED<=4 @1
C     Process: u s > e+ e- u s WEIGHTED<=4 @1
C     Process: u b > e+ e- u b WEIGHTED<=4 @1
C     Process: u u~ > e+ e- c c~ WEIGHTED<=4 @1
C     Process: u u~ > e+ e- s s~ WEIGHTED<=4 @1
C     Process: u u~ > e+ e- b b~ WEIGHTED<=4 @1
C     Process: u c~ > e+ e- u c~ WEIGHTED<=4 @1
C     Process: u s~ > e+ e- u s~ WEIGHTED<=4 @1
C     Process: u b~ > e+ e- u b~ WEIGHTED<=4 @1
C     Process: c d > e+ e- c d WEIGHTED<=4 @1
C     Process: c u~ > e+ e- c u~ WEIGHTED<=4 @1
C     Process: s u~ > e+ e- s u~ WEIGHTED<=4 @1
C     Process: b u~ > e+ e- b u~ WEIGHTED<=4 @1
C     Process: c c~ > e+ e- u u~ WEIGHTED<=4 @1
C     Process: s s~ > e+ e- u u~ WEIGHTED<=4 @1
C     Process: b b~ > e+ e- u u~ WEIGHTED<=4 @1
C     Process: c c~ > e+ e- d d~ WEIGHTED<=4 @1
C     Process: s s~ > e+ e- d d~ WEIGHTED<=4 @1
C     Process: b b~ > e+ e- d d~ WEIGHTED<=4 @1
C     Process: c d~ > e+ e- c d~ WEIGHTED<=4 @1
C     Process: s d~ > e+ e- s d~ WEIGHTED<=4 @1
C     Process: b d~ > e+ e- b d~ WEIGHTED<=4 @1
C     Process: d s > e+ e- d s WEIGHTED<=4 @1
C     Process: d b > e+ e- d b WEIGHTED<=4 @1
C     Process: d c~ > e+ e- d c~ WEIGHTED<=4 @1
C     Process: d s~ > e+ e- d s~ WEIGHTED<=4 @1
C     Process: d b~ > e+ e- d b~ WEIGHTED<=4 @1
C     Process: d d~ > e+ e- c c~ WEIGHTED<=4 @1
C     Process: d d~ > e+ e- s s~ WEIGHTED<=4 @1
C     Process: d d~ > e+ e- b b~ WEIGHTED<=4 @1
C     Process: u~ c~ > e+ e- u~ c~ WEIGHTED<=4 @1
C     Process: u~ s~ > e+ e- u~ s~ WEIGHTED<=4 @1
C     Process: u~ b~ > e+ e- u~ b~ WEIGHTED<=4 @1
C     Process: c~ d~ > e+ e- c~ d~ WEIGHTED<=4 @1
...
C       Output weights and number of events
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(52E12.4)')((SUMWGT(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        SUMPROB=0D0
        ...
        IF (SUMPROB.NE.0D0)THEN
          DO J=1,SYMCONF(0)
            WRITE(*,'(52E12.4)')((NUMEVTS(K,I,J)/SUMPROB,K=1,2),I=1
     $       ,MAXSPROC)
          ENDDO
        ENDIF
        WRITE(*,*)'Events:'
        DO J=1,SYMCONF(0)
          WRITE(*,'(52I12)')((NUMEVTS(K,I,J),K=1,2),I=1,MAXSPROC)
        ENDDO
...
C       Flip CM_RAP (to get rapidity right)
      ...
      IF (PASSCUTS(P1)) THEN
        ...
        IF(IPROC.EQ.8) DSIGPROC=DSIG8(P1,WGT,IMODE)  ! u u~ > e+ e- d d~
        IF(IPROC.EQ.9) DSIGPROC=DSIG9(P1,WGT,IMODE)  ! u d~ > e+ e- u d~
        IF(IPROC.EQ.10) DSIGPROC=DSIG10(P1,WGT,IMODE)  ! d u~ > e+ e- d u~
        IF(IPROC.EQ.11) DSIGPROC=DSIG11(P1,WGT,IMODE)  ! d d~ > e+ e- u u~
        IF(IPROC.EQ.12) DSIGPROC=DSIG12(P1,WGT,IMODE)  ! u~ d~ > e+ e- u~ d~
        IF(IPROC.EQ.13) DSIGPROC=DSIG13(P1,WGT,IMODE)  ! u c > e+ e- u c
        IF(IPROC.EQ.14) DSIGPROC=DSIG14(P1,WGT,IMODE)  ! u u~ > e+ e- c c~
        IF(IPROC.EQ.15) DSIGPROC=DSIG15(P1,WGT,IMODE)  ! u c~ > e+ e- u c~
        IF(IPROC.EQ.16) DSIGPROC=DSIG16(P1,WGT,IMODE)  ! c d > e+ e- c d
        IF(IPROC.EQ.17) DSIGPROC=DSIG17(P1,WGT,IMODE)  ! c u~ > e+ e- c u~
        IF(IPROC.EQ.18) DSIGPROC=DSIG18(P1,WGT,IMODE)  ! c c~ > e+ e- u u~
        IF(IPROC.EQ.19) DSIGPROC=DSIG19(P1,WGT,IMODE)  ! c c~ > e+ e- d d~
        IF(IPROC.EQ.20) DSIGPROC=DSIG20(P1,WGT,IMODE)  ! c d~ > e+ e- c d~
        IF(IPROC.EQ.21) DSIGPROC=DSIG21(P1,WGT,IMODE)  ! d s > e+ e- d s
        IF(IPROC.EQ.22) DSIGPROC=DSIG22(P1,WGT,IMODE)  ! d c~ > e+ e- d c~
        IF(IPROC.EQ.23) DSIGPROC=DSIG23(P1,WGT,IMODE)  ! d d~ > e+ e- c c~
        IF(IPROC.EQ.24) DSIGPROC=DSIG24(P1,WGT,IMODE)  ! u~ c~ > e+ e- u~ c~
        IF(IPROC.EQ.25) DSIGPROC=DSIG25(P1,WGT,IMODE)  ! c~ d~ > e+ e- c~ d~
        IF(IPROC.EQ.26) DSIGPROC=DSIG26(P1,WGT,IMODE)  ! d~ s~ > e+ e- d~ s~
      ENDIF
