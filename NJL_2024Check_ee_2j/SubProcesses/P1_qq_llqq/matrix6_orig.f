...
C     
C     Process: d~ d~ > e+ e- d~ d~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Needed for v4 models
      ...
      DOUBLE PRECISION FK_MDL_WPID23UNO
      DOUBLE PRECISION FK_ZERO
      SAVE FK_MDL_WPID23UNO
      SAVE FK_ZERO
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WPID23UNO.NE.0D0) FK_MDL_WPID23UNO =
     $    SIGN(MAX(ABS(MDL_WPID23UNO), ABS(MDL_MASSB
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPID23UNO)
      ...
      CALL FFS2_3(W(1,5),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23UNO,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS1_1(W(1,2),W(1,7),GC_63,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS2_0(W(1,6),W(1,12),W(1,9),GC_63,AMP(5))
      CALL FFS1_1(W(1,1),W(1,7),GC_63,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,6),W(1,12),W(1,10),GC_63,AMP(6))
      CALL FFV1P0_3(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,12))
      CALL FFS2_3(W(1,6),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23UNO,W(1
     $ ,7))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFS2_2(W(1,5),W(1,9),GC_63,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL FFS1_0(W(1,12),W(1,2),W(1,7),GC_63,AMP(13))
      CALL FFS2_2(W(1,5),W(1,10),GC_63,ZERO, FK_ZERO,W(1,12))
