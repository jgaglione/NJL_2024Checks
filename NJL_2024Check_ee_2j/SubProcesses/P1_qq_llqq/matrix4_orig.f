...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS1_3(W(1,3),W(1,5),GC_63,MDL_MASSB, FK_MDL_WPID23UNO,W(1
     $ ,10))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS1_1(W(1,5),W(1,7),GC_63,ZERO, FK_ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFS2_2(W(1,1),W(1,9),GC_63,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL FFS1_0(W(1,12),W(1,5),W(1,7),GC_63,AMP(13))
      CALL FFS2_2(W(1,1),W(1,10),GC_63,ZERO, FK_ZERO,W(1,12))
