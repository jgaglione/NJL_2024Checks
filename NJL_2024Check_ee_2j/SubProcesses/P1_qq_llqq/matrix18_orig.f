...
C     ----------
     ...
     $ )
      ...
      CALL FFS1_2(W(1,3),W(1,7),GC_62,ZERO, FK_ZERO,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,2),W(1,5),W(1,8),GC_16,AMP(1))
      CALL FFS1_3(W(1,3),W(1,5),GC_62,MDL_MASSB, FK_MDL_WPI53UNO,W(1,2)
     $ )
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,8),W(1,7),W(1,2),GC_15,AMP(2))
      CALL FFV1_2(W(1,6),W(1,8),GC_16,ZERO, FK_ZERO,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,7),W(1,4),W(1,2),GC_62,AMP(3))
