...
C     
C     Process: g g > e+ e- u u~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPI53UNO)
      ...
      CALL FFS1_3(W(1,3),W(1,5),GC_62,MDL_MASSB, FK_MDL_WPI53UNO,W(1,8)
     $ )
      CALL FFV1_2(W(1,6),W(1,7),GC_16,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFS2_0(W(1,9),W(1,4),W(1,8),GC_62,AMP(1))
      CALL FFS2_3(W(1,6),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53UNO,W(1,9)
     $ )
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,7),W(1,9),W(1,8),GC_15,AMP(2))
      CALL FFV1_1(W(1,5),W(1,7),GC_16,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFS1_0(W(1,3),W(1,10),W(1,9),GC_62,AMP(3))
      CALL FFV1_1(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,2),GC_16,ZERO, FK_ZERO,W(1,7))
      CALL FFS1_3(W(1,3),W(1,10),GC_62,MDL_MASSB, ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,7),W(1,4),W(1,11),GC_62,AMP(4))
      CALL FFV1_1(W(1,10),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,3),W(1,12),W(1,9),GC_62,AMP(5))
