...
C     
C     Process: g g > vm vm~ s s~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPI13DUE)
      ...
      CALL FFS2_3(W(1,6),W(1,3),GC_61,MDL_MASSB, FK_MDL_WPI13DUE,W(1,8)
     $ )
      CALL FFV1_1(W(1,5),W(1,7),GC_16,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,4),W(1,9),W(1,8),GC_61,AMP(1))
...
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,10),W(1,3),W(1,9),GC_61,AMP(3))
      CALL FFV1_1(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,2),GC_16,ZERO, FK_ZERO,W(1,7))
      CALL FFS1_3(W(1,4),W(1,10),GC_61,MDL_MASSB, ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,7),W(1,3),W(1,11),GC_61,AMP(4))
      CALL FFV1_1(W(1,10),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,4),W(1,12),W(1,8),GC_61,AMP(5))
