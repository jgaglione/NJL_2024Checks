...
C     
C     Process: g g > vm vm~ c c~ WEIGHTED<=4 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $ ,8))
      CALL FFV1_1(W(1,5),W(1,7),GC_16,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFS1_0(W(1,4),W(1,9),W(1,8),GC_64,AMP(1))
      CALL FFS1_3(W(1,4),W(1,5),GC_64,MDL_MASSB, FK_MDL_WPIU23DUE,W(1
     $ ,9))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,7),W(1,8),W(1,9),GC_15,AMP(2))
      CALL FFV1_2(W(1,6),W(1,7),GC_16,ZERO, FK_ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL FFS2_0(W(1,10),W(1,3),W(1,9),GC_64,AMP(3))
      CALL FFV1_1(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,10))
      CALL FFV1_2(W(1,6),W(1,2),GC_16,ZERO, FK_ZERO,W(1,7))
      CALL FFS1_3(W(1,4),W(1,10),GC_64,MDL_MASSB, ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFS2_0(W(1,7),W(1,3),W(1,11),GC_64,AMP(4))
      CALL FFV1_1(W(1,10),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS1_0(W(1,4),W(1,12),W(1,8),GC_64,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL VSS1_0(W(1,2),W(1,8),W(1,11),GC_15,AMP(6))
      CALL FFV1_2(W(1,6),W(1,1),GC_16,ZERO, FK_ZERO,W(1,11))
      CALL FFV1_1(W(1,5),W(1,2),GC_16,ZERO, FK_ZERO,W(1,6))
      CALL FFS2_3(W(1,11),W(1,3),GC_64,MDL_MASSB, ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFS1_0(W(1,4),W(1,6),W(1,5),GC_64,AMP(7))
      CALL FFV1_2(W(1,11),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 8
      CALL FFS2_0(W(1,12),W(1,3),W(1,9),GC_64,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL VSS1_0(W(1,2),W(1,5),W(1,9),GC_15,AMP(9))
      CALL FFV1_1(W(1,6),W(1,1),GC_16,ZERO, FK_ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFS1_0(W(1,4),W(1,5),W(1,8),GC_64,AMP(10))
      CALL VSS1_3(W(1,1),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFS1_0(W(1,4),W(1,6),W(1,5),GC_64,AMP(11))
      CALL FFV1_2(W(1,7),W(1,1),GC_16,ZERO, FK_ZERO,W(1,6))
C     Amplitude(s) for diagram number 12
      CALL FFS2_0(W(1,6),W(1,3),W(1,9),GC_64,AMP(12))
      CALL VSS1_2(W(1,1),W(1,9),GC_15,MDL_MASSB, ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFS2_0(W(1,7),W(1,3),W(1,6),GC_64,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL VVSS1_0(W(1,1),W(1,2),W(1,8),W(1,9),GC_20,AMP(14))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,8),W(1,9),GC_20,AMP(15))
C     Amplitude(s) for diagram number 15
      CALL VSS1_0(W(1,2),W(1,5),W(1,9),GC_15,AMP(16))
C     Amplitude(s) for diagram number 16
      CALL VSS1_0(W(1,2),W(1,8),W(1,6),GC_15,AMP(17))
C     JAMPs contributing to orders ALL_ORDERS=1
     ...
     $ *AMP(17)+((0.000000000000000D+00,1.000000000000000D+00))
     $ *TMP_JAMP(2)
     ...
     $ *AMP(16)+((0.000000000000000D+00,-1.000000000000000D+00))
     $ *TMP_JAMP(2)
