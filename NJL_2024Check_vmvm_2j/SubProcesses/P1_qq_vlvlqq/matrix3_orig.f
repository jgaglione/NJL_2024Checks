...
C     Amplitude(s) for diagram number 1
      ...
      CALL FFS1_3(W(1,4),W(1,6),GC_61,MDL_MASSB, FK_MDL_WPI13DUE,W(1
     $ ,10))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFS1_3(W(1,4),W(1,5),GC_61,MDL_MASSB, FK_MDL_WPI13DUE,W(1,9)
     $ )
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,11),W(1,7),W(1,9),GC_15,AMP(4))
      CALL FFS1_1(W(1,6),W(1,7),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS2_0(W(1,2),W(1,12),W(1,9),GC_61,AMP(5))
      CALL FFS1_1(W(1,5),W(1,7),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,2),W(1,12),W(1,10),GC_61,AMP(6))
      CALL FFV1P0_3(W(1,1),W(1,5),GC_16,ZERO, FK_ZERO,W(1,12))
      CALL FFS2_3(W(1,2),W(1,3),GC_61,MDL_MASSB, ZERO,W(1,7))
...
C     Amplitude(s) for diagram number 13
      CALL FFS1_0(W(1,12),W(1,6),W(1,7),GC_61,AMP(13))
      CALL FFS2_2(W(1,1),W(1,10),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 14
      CALL FFS1_0(W(1,12),W(1,5),W(1,7),GC_61,AMP(14))
