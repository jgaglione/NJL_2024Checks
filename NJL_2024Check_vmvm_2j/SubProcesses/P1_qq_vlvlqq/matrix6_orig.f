...
C     Needed for v4 models
      ...
      DOUBLE PRECISION FK_MDL_WPI13DUE
      SAVE FK_ZERO
      SAVE FK_MDL_WPI13DUE
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), ZERO)
        IF(MDL_WPI13DUE.NE.0D0) FK_MDL_WPI13DUE =
     $    SIGN(MAX(ABS(MDL_WPI13DUE), ABS(MDL_MASSB
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPI13DUE)
      ...
      CALL FFS2_3(W(1,5),W(1,3),GC_61,MDL_MASSB, FK_MDL_WPI13DUE,W(1,7)
     $ )
      CALL FFV1P0_3(W(1,6),W(1,1),GC_16,ZERO, FK_ZERO,W(1,8))
      CALL FFS1_2(W(1,4),W(1,7),GC_61,ZERO, FK_ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_16,AMP(1))
      CALL FFS1_3(W(1,4),W(1,2),GC_61,MDL_MASSB, ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFS1_3(W(1,4),W(1,1),GC_61,MDL_MASSB, ZERO,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,11),W(1,7),W(1,9),GC_15,AMP(4))
      CALL FFS1_1(W(1,2),W(1,7),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFS2_0(W(1,6),W(1,12),W(1,9),GC_61,AMP(5))
      CALL FFS1_1(W(1,1),W(1,7),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL FFS2_0(W(1,6),W(1,12),W(1,10),GC_61,AMP(6))
      CALL FFV1P0_3(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,12))
      CALL FFS2_3(W(1,6),W(1,3),GC_61,MDL_MASSB, FK_MDL_WPI13DUE,W(1,7)
     $ )
      CALL FFV1_1(W(1,2),W(1,12),GC_16,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 7
      CALL FFS1_0(W(1,4),W(1,13),W(1,7),GC_61,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL VSS1_0(W(1,12),W(1,7),W(1,10),GC_15,AMP(8))
      CALL FFV1_2(W(1,6),W(1,12),GC_16,ZERO, FK_ZERO,W(1,13))
C     Amplitude(s) for diagram number 9
      CALL FFS2_0(W(1,13),W(1,3),W(1,10),GC_61,AMP(9))
      CALL FFV1P0_3(W(1,5),W(1,2),GC_16,ZERO, FK_ZERO,W(1,13))
      CALL FFV1_1(W(1,1),W(1,13),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 10
      CALL FFS1_0(W(1,4),W(1,12),W(1,7),GC_61,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL VSS1_0(W(1,13),W(1,7),W(1,9),GC_15,AMP(11))
      CALL FFV1_2(W(1,6),W(1,13),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 12
      CALL FFS2_0(W(1,12),W(1,3),W(1,9),GC_61,AMP(12))
      CALL FFS2_2(W(1,5),W(1,9),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 13
      CALL FFS1_0(W(1,12),W(1,2),W(1,7),GC_61,AMP(13))
      CALL FFS2_2(W(1,5),W(1,10),GC_61,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 14
      CALL FFS1_0(W(1,12),W(1,1),W(1,7),GC_61,AMP(14))
      CALL FFV1_2(W(1,5),W(1,8),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 15
      CALL FFS2_0(W(1,12),W(1,3),W(1,10),GC_61,AMP(15))
      CALL FFV1_2(W(1,5),W(1,11),GC_16,ZERO, FK_ZERO,W(1,12))
C     Amplitude(s) for diagram number 16
      CALL FFS2_0(W(1,12),W(1,3),W(1,9),GC_61,AMP(16))
