...
C     
C     Process: g s > mu+ mu- s WEIGHTED<=3 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPID23DUE)
      ...
      CALL FFV1_2(W(1,2),W(1,1),GC_16,ZERO, FK_ZERO,W(1,6))
      CALL FFS1_3(W(1,3),W(1,5),GC_63,MDL_MASSB, FK_MDL_WPID23DUE,W(1
     $ ,7))
C     Amplitude(s) for diagram number 1
      CALL FFS2_0(W(1,6),W(1,4),W(1,7),GC_63,AMP(1))
      CALL FFV1_1(W(1,5),W(1,1),GC_16,ZERO, FK_ZERO,W(1,6))
      CALL FFS2_3(W(1,2),W(1,4),GC_63,MDL_MASSB, ZERO,W(1,5))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,3),W(1,6),W(1,5),GC_63,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,1),W(1,5),W(1,7),GC_15,AMP(3))
