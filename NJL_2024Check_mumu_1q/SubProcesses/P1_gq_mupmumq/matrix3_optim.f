...
C     
C     Process: g c~ > mu+ mu- c~ WEIGHTED<=3 @1
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      CALL OXXXXX(P(0,4),MDL_MM,+1,+1*IC(4),W(1,6)) ! count 3
      CALL OXXXXX(P(0,4),MDL_MM,-1,+1*IC(4),W(1,7)) ! count 5
      CALL IXXXXX(P(0,5),ZERO,-1,-1*IC(5),W(1,8)) ! count 4
      CALL FFV1_2(W(1,8),W(1,1),GC_16,ZERO, FK_ZERO,W(1,9)) ! count 3
      CALL FFV1_2(W(1,8),W(1,2),GC_16,ZERO, FK_ZERO,W(1,10)) ! count 3
      CALL FFS1_3(W(1,4),W(1,3),GC_62,MDL_MASSB, ZERO,W(1,11)) ! count 8
      CALL FFS1_3(W(1,5),W(1,3),GC_62,MDL_MASSB, ZERO,W(1,12)) ! count 4
      CALL FFS2P1N_1(W(1,6), W(1,11), GC_62, TMP(1))
      call CombineAmp(2,
     & (/5,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFS2P1N_1(W(1,7), W(1,11), GC_62, TMP(1))
      call CombineAmp(2,
     & (/4,1/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFS2P1N_1(W(1,7), W(1,12), GC_62, TMP(1))
      call CombineAmp(2,
     & (/6,3/), 
     & (/9,10/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFV1_1(W(1,3),W(1,1),GC_16,ZERO, FK_ZERO,W(1,13)) ! count 3
      CALL FFV1_1(W(1,3),W(1,2),GC_16,ZERO, FK_ZERO,W(1,14)) ! count 3
      CALL FFS2_3(W(1,8),W(1,6),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,15)) ! count 4
      CALL FFS2_3(W(1,8),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,16)) ! count 8
      CALL FFS1_0(W(1,4),W(1,13),W(1,15),GC_62,AMP(5,2))
      CALL FFS1P1N_1(W(1,13), W(1,16), GC_62, TMP(1))
      call CombineAmp(2,
     & (/4,6/), 
     & (/4,5/),
     & TMP, W, AMP(1,2))
      CALL FFS1_0(W(1,4),W(1,14),W(1,15),GC_62,AMP(2,2))
      CALL FFS1P1N_1(W(1,14), W(1,16), GC_62, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/4,5/),
     & TMP, W, AMP(1,2)) ! count 1
      CALL VSS1P1N_1(W(1,15), W(1,11), GC_15, TMP(1))
      call CombineAmp(2,
     & (/5,2/), 
     & (/1,2/),
     & TMP, W, AMP(1,3))
      CALL VSS1P1N_1(W(1,16), W(1,11), GC_15, TMP(1))
      call CombineAmp(2,
     & (/4,1/), 
     & (/1,2/),
     & TMP, W, AMP(1,3))
      CALL VSS1P1N_1(W(1,16), W(1,12), GC_15, TMP(1))
      call CombineAmp(2,
     & (/6,3/), 
     & (/1,2/),
