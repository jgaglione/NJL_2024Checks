...
C     
C     Process: c c~ > pi53due pi53due~ WEIGHTED<=2 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      CALL FFS1_3(W(1,5),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,8)) ! count 5
      CALL FFS1_3(W(1,6),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,9)) ! count 3
      ...
      CALL FFS2_3(W(1,12),W(1,10),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,13)) ! count 3
      CALL FFS2_3(W(1,12),W(1,11),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,14)) ! count 6
      CALL FFV1P0_3(W(1,1),W(1,4),GC_16,ZERO, FK_ZERO,W(1,15)) ! count 3
      CALL FFV1P0_3(W(1,2),W(1,3),GC_16,ZERO, FK_ZERO,W(1,16)) ! count 3
     ...
     & TMP, W, AMP(1,1)) ! count 1
      CALL FFS2_2(W(1,1),W(1,8),GC_62,MDL_MM, FK_ZERO,W(1,17)) ! count 2
      CALL FFS2_2(W(1,1),W(1,9),GC_62,MDL_MM, FK_ZERO,W(1,18)) ! count 1
      CALL FFS1_0(W(1,17),W(1,4),W(1,13),GC_62,AMP(2,2))
      CALL FFS1P1N_1(W(1,4), W(1,14), GC_62, TMP(1))
      call CombineAmp(2,
     & (/1,3/), 
     & (/17,18/),
     & TMP, W, AMP(1,2)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(2,1) = (-5.000000000000000D-01)*AMP( K,1)+(-1.0000000000000
     $  00D +00)*AMP( K,2)
