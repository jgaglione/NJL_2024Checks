...
C     
C     Process: u u~ > pi53due pi53due~ WEIGHTED<=2 @1
C     *   Decay: pi53due > mu+ c WEIGHTED<=1
C     *   Decay: pi53due~ > mu- c~ WEIGHTED<=1
C     Process: d d~ > pi53due pi53due~ WEIGHTED<=2 @1
C     *   Decay: pi53due > mu+ c WEIGHTED<=1
C     *   Decay: pi53due~ > mu- c~ WEIGHTED<=1
C     Process: s s~ > pi53due pi53due~ WEIGHTED<=2 @1
C     *   Decay: pi53due > mu+ c WEIGHTED<=1
C     *   Decay: pi53due~ > mu- c~ WEIGHTED<=1
C     Process: b b~ > pi53due pi53due~ WEIGHTED<=2 @1
C     *   Decay: pi53due > mu+ c WEIGHTED<=1
C     *   Decay: pi53due~ > mu- c~ WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      CALL FFS1_3(W(1,5),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,8)) ! count 4
      CALL FFS1_3(W(1,6),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,9)) ! count 2
      ...
      CALL FFS2_3(W(1,12),W(1,10),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,13)) ! count 2
      CALL FFS2_3(W(1,12),W(1,11),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,14)) ! count 4
