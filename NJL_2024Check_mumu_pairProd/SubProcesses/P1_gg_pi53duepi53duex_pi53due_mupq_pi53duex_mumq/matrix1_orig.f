...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPI53DUE)
      ...
      CALL FFS1_3(W(1,3),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,5)
     $ )
      CALL OXXXXX(P(0,5),MDL_MM,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),ZERO,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS2_3(W(1,3),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,6)
     $ )
