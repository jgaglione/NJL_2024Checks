...
C     
C     Process: g g > pi53due pi53due~ WEIGHTED<=2 @1
C     *   Decay: pi53due > mu+ c WEIGHTED<=1
C     *   Decay: pi53due~ > mu- c~ WEIGHTED<=1
C     
      IMPLICIT NONE
C     
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      CALL VXXXXX(P(0,2),ZERO,+1,-1*IC(2),W(1,3)) ! count 19
      CALL VXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,4)) ! count 19
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,5)) ! count 1
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,6)) ! count 1
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,7)) ! count 2
      CALL FFS1_3(W(1,5),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,8)) ! count 22
      CALL FFS1_3(W(1,6),W(1,7),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,9)) ! count 12
      CALL OXXXXX(P(0,5),MDL_MM,+1,+1*IC(5),W(1,10)) ! count 1
      CALL OXXXXX(P(0,5),MDL_MM,-1,+1*IC(5),W(1,11)) ! count 1
      CALL IXXXXX(P(0,6),ZERO,-1,-1*IC(6),W(1,12)) ! count 2
      CALL FFS2_3(W(1,12),W(1,10),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,13)) ! count 12
      CALL FFS2_3(W(1,12),W(1,11),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,14)) ! count 22
      CALL VVSS1_0(W(1,1),W(1,3),W(1,13),W(1,8),GC_20,AMP(11,1))
      CALL VVSS1_0(W(1,1),W(1,3),W(1,14),W(1,8),GC_20,AMP(10,1))
      CALL VVSS1_0(W(1,1),W(1,3),W(1,14),W(1,9),GC_20,AMP(12,1))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,13),W(1,8),GC_20,AMP(2,1))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,14),W(1,8),GC_20,AMP(1,1))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,14),W(1,9),GC_20,AMP(3,1)) ! count 1
      CALL VVSS1_0(W(1,1),W(1,3),W(1,13),W(1,8),GC_20,AMP(11,2))
      CALL VVSS1_0(W(1,1),W(1,3),W(1,14),W(1,8),GC_20,AMP(10,2))
      CALL VVSS1_0(W(1,1),W(1,3),W(1,14),W(1,9),GC_20,AMP(12,2))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,13),W(1,8),GC_20,AMP(2,2))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,14),W(1,8),GC_20,AMP(1,2))
      CALL VVSS1_0(W(1,2),W(1,4),W(1,14),W(1,9),GC_20,AMP(3,2)) ! count 1
      CALL VVV1P0_1(W(1,1),W(1,3),GC_14,ZERO, FK_ZERO,W(1,15)) ! count 3
      CALL VVV1P0_1(W(1,2),W(1,4),GC_14,ZERO, FK_ZERO,W(1,18)) ! count 3
      CALL VSS1P1N_1(W(1,13), W(1,8), GC_15, TMP(1))
      call CombineAmp(2,
     & (/11,2/), 
     & (/15,18/),
     & TMP, W, AMP(1,3))
      CALL VSS1P1N_1(W(1,14), W(1,8), GC_15, TMP(1))
      call CombineAmp(2,
     & (/10,1/), 
     & (/15,18/),
     & TMP, W, AMP(1,3))
      CALL VSS1P1N_1(W(1,14), W(1,9), GC_15, TMP(1))
      call CombineAmp(2,
     & (/12,3/), 
     & (/15,18/),
     & TMP, W, AMP(1,3)) ! count 1
      CALL VSS1_2(W(1,1),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,19)) ! count 4
      CALL VSS1_2(W(1,1),W(1,9),GC_15,MDL_MASSB, ZERO,W(1,20)) ! count 2
      CALL VSS1_2(W(1,2),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,21)) ! count 4
      CALL VSS1_2(W(1,2),W(1,9),GC_15,MDL_MASSB, ZERO,W(1,22)) ! count 2
      CALL VSS1P1N_3(W(1,3), W(1,13), GC_15, TMP(1))
      call CombineAmpS(2, 
     &(/11,5/), 
     & (/19,21/), 
     & TMP, W, AMP(1,4))
      CALL VSS1P1N_3(W(1,3), W(1,14), GC_15, TMP(1))
      call CombineAmpS(4, 
     &(/10,12,4,6/), 
     & (/19,20,21,22/), 
     & TMP, W, AMP(1,4))
      CALL VSS1P1N_3(W(1,4), W(1,13), GC_15, TMP(1))
      call CombineAmpS(2, 
     &(/8,2/), 
     & (/19,21/), 
     & TMP, W, AMP(1,4))
      CALL VSS1P1N_3(W(1,4), W(1,14), GC_15, TMP(1))
      call CombineAmpS(4, 
     &(/7,9,1,3/), 
     & (/19,20,21,22/), 
     & TMP, W, AMP(1,4)) ! count 1
      CALL VSS1_3(W(1,1),W(1,13),GC_15,MDL_MASSB, ZERO,W(1,23)) ! count 2
      CALL VSS1_3(W(1,1),W(1,14),GC_15,MDL_MASSB, ZERO,W(1,24)) ! count 4
      CALL VSS1_3(W(1,2),W(1,13),GC_15,MDL_MASSB, ZERO,W(1,25)) ! count 2
      CALL VSS1_3(W(1,2),W(1,14),GC_15,MDL_MASSB, ZERO,W(1,26)) ! count 4
      CALL VSS1P1N_2(W(1,3), W(1,8), GC_15, TMP(1))
      call CombineAmpS(4, 
     &(/11,10,5,4/), 
     & (/23,24,25,26/), 
     & TMP, W, AMP(1,5))
      CALL VSS1P1N_2(W(1,3), W(1,9), GC_15, TMP(1))
      call CombineAmpS(2, 
     &(/12,6/), 
     & (/24,26/), 
     & TMP, W, AMP(1,5))
      CALL VSS1P1N_2(W(1,4), W(1,8), GC_15, TMP(1))
      call CombineAmpS(4, 
     &(/8,7,2,1/), 
     & (/23,24,25,26/), 
     & TMP, W, AMP(1,5))
      CALL VSS1P1N_2(W(1,4), W(1,9), GC_15, TMP(1))
      call CombineAmpS(2, 
     &(/9,3/), 
     & (/24,26/), 
     & TMP, W, AMP(1,5)) ! count 1
      DO K = 1, NCOMB
        ...
        JAMP(1,1) = (-1.000000000000000D+00)*AMP( K,2)+((0.0000000000000
     $  00D +00,1.000000000000000D+00))*AMP( K,3)+(-1.000000000000000D+00) *AMP(
     $   K,4)
        JAMP(2,1) = (-1.000000000000000D+00)*AMP( K,1)+((0.0000000000000
     $  00D +00,-1.000000000000000D+00))*AMP( K,3)+(-1.000000000000000D+00) *AMP
     $  ( K,5)
