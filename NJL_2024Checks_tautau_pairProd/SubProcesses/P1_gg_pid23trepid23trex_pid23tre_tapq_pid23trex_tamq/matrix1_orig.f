...
C     
C     Process: g g > pid23tre pid23tre~ WEIGHTED<=2 @1
C     *   Decay: pid23tre > ta+ b WEIGHTED<=1
C     *   Decay: pid23tre~ > ta- b~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
...
C     ----------
     ...
     $   *SMALL_WIDTH_TREATMENT)), MDL_WPID23TRE)
      ...
      CALL FFS1_3(W(1,3),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23TRE,W(1
     $ ,5))
      CALL OXXXXX(P(0,5),MDL_MTA,NHEL(5),+1*IC(5),W(1,4))
      CALL IXXXXX(P(0,6),ZERO,NHEL(6),-1*IC(6),W(1,3))
      CALL FFS2_3(W(1,3),W(1,4),GC_63,MDL_MASSB, FK_MDL_WPID23TRE,W(1
     $ ,6))
C     Amplitude(s) for diagram number 1
      CALL VVSS1_0(W(1,1),W(1,2),W(1,6),W(1,5),GC_20,AMP(1))
      CALL VVSS1_0(W(1,1),W(1,2),W(1,6),W(1,5),GC_20,AMP(2))
      CALL VVV1P0_1(W(1,1),W(1,2),GC_14,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL VSS1_0(W(1,3),W(1,6),W(1,5),GC_15,AMP(3))
      CALL VSS1_2(W(1,1),W(1,5),GC_15,MDL_MASSB, ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL VSS1_0(W(1,2),W(1,6),W(1,3),GC_15,AMP(4))
      CALL VSS1_3(W(1,1),W(1,6),GC_15,MDL_MASSB, ZERO,W(1,3))
C     Amplitude(s) for diagram number 4
      CALL VSS1_0(W(1,2),W(1,3),W(1,5),GC_15,AMP(5))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (-1.000000000000000D+00)*AMP(2)+((0.000000000000000D
     $ +00,1.000000000000000D+00))*AMP(3)+(-1.000000000000000D+00)
     $ *AMP(4)
      JAMP(2,1) = (-1.000000000000000D+00)*AMP(1)+((0.000000000000000D
     $ +00,-1.000000000000000D+00))*AMP(3)+(-1.000000000000000D+00)
     $ *AMP(5)
