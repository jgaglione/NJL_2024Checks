...
C     
C     Process: u u~ > pid23tre pid23tre~ WEIGHTED<=2 @1
C     *   Decay: pid23tre > ta+ b WEIGHTED<=1
C     *   Decay: pid23tre~ > ta- b~ WEIGHTED<=1
C     Process: c c~ > pid23tre pid23tre~ WEIGHTED<=2 @1
C     *   Decay: pid23tre > ta+ b WEIGHTED<=1
C     *   Decay: pid23tre~ > ta- b~ WEIGHTED<=1
C     Process: d d~ > pid23tre pid23tre~ WEIGHTED<=2 @1
C     *   Decay: pid23tre > ta+ b WEIGHTED<=1
C     *   Decay: pid23tre~ > ta- b~ WEIGHTED<=1
C     Process: s s~ > pid23tre pid23tre~ WEIGHTED<=2 @1
C     *   Decay: pid23tre > ta+ b WEIGHTED<=1
C     *   Decay: pid23tre~ > ta- b~ WEIGHTED<=1
C     
      USE DISCRETESAMPLER
