...
C     
C     Process: b b~ > pid23tre pid23tre~ WEIGHTED<=2 @1
...
C     ----------
     ...
     $ ,6))
      CALL FFV1P0_3(W(1,1),W(1,2),GC_16,ZERO, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VSS1_0(W(1,3),W(1,6),W(1,5),GC_15,AMP(1))
      CALL FFS2_2(W(1,1),W(1,5),GC_63,MDL_MTA, FK_ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFS1_0(W(1,3),W(1,2),W(1,6),GC_63,AMP(2))
C     JAMPs contributing to orders ALL_ORDERS=1
      JAMP(1,1) = (1.666666666666667D-01)*AMP(1)
      JAMP(2,1) = (-5.000000000000000D-01)*AMP(1)+(-1.000000000000000D
     $ +00)*AMP(2)
