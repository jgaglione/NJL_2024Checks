...
C     
C     Process: g c~ > pi53due~ mu+ WEIGHTED<=2 @2
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 3
      CALL OXXXXX(P(0,2),ZERO,-1,-1*IC(2),W(1,3)) ! count 7
      CALL OXXXXX(P(0,3),MDL_MM,+1,+1*IC(3),W(1,4)) ! count 1
      CALL OXXXXX(P(0,3),MDL_MM,-1,+1*IC(3),W(1,5)) ! count 1
      CALL IXXXXX(P(0,4),ZERO,-1,-1*IC(4),W(1,6)) ! count 2
      CALL FFS2_3(W(1,6),W(1,4),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,7)) ! count 3
      CALL FFS2_3(W(1,6),W(1,5),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,8)) ! count 4
      CALL IXXXXX(P(0,5),MDL_MM,+1,-1*IC(5),W(1,9)) ! count 6
      CALL IXXXXX(P(0,5),MDL_MM,-1,-1*IC(5),W(1,10)) ! count 3
      CALL FFV1_1(W(1,3),W(1,2),GC_16,ZERO, FK_ZERO,W(1,12)) ! count 3
      CALL FFS1_0(W(1,9),W(1,12),W(1,7),GC_62,AMP(3,1))
      CALL FFS1P1N_1(W(1,12), W(1,8), GC_62, TMP(1))
      call CombineAmp(2,
     & (/1,2/), 
     & (/9,10/),
     & TMP, W, AMP(1,1)) ! count 1
      CALL VSS1_3(W(1,1),W(1,7),GC_15,MDL_MASSB, ZERO,W(1,13)) ! count 1
      CALL VSS1_3(W(1,1),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,14)) ! count 2
      CALL VSS1_3(W(1,2),W(1,7),GC_15,MDL_MASSB, ZERO,W(1,15)) ! count 1
      CALL VSS1_3(W(1,2),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,16)) ! count 2
      CALL FFS1P1N_3(W(1,9), W(1,3), GC_62, TMP(1))
      call CombineAmpS(4, 
     &(/6,4,3,1/), 
     & (/13,14,15,16/), 
     & TMP, W, AMP(1,2))
      CALL FFS1P1N_3(W(1,10), W(1,3), GC_62, TMP(1))
      call CombineAmpS(2, 
     &(/5,2/), 
     & (/14,16/), 
