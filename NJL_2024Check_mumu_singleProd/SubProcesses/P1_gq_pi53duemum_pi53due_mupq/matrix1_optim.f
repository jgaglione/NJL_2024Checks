...
C     
C     Process: g c > pi53due mu- WEIGHTED<=2 @1
...
C     ----------
     ...
     $   *small_width_treatment)), mdl_WPi53due)
      ...
      AMP(:,:) = (0d0,0d0)
            CALL VXXXXX(P(0,1),ZERO,+1,-1*IC(1),W(1,1)) ! count 3
      CALL VXXXXX(P(0,1),ZERO,-1,-1*IC(1),W(1,2)) ! count 2
      CALL IXXXXX(P(0,2),ZERO,+1,+1*IC(2),W(1,3)) ! count 7
      CALL IXXXXX(P(0,3),MDL_MM,+1,-1*IC(3),W(1,4)) ! count 1
      CALL IXXXXX(P(0,3),MDL_MM,-1,-1*IC(3),W(1,5)) ! count 1
      CALL OXXXXX(P(0,4),ZERO,+1,+1*IC(4),W(1,6)) ! count 2
      CALL FFS1_3(W(1,4),W(1,6),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,7)) ! count 4
      CALL FFS1_3(W(1,5),W(1,6),GC_62,MDL_MASSB, FK_MDL_WPI53DUE,W(1,8)) ! count 3
      CALL OXXXXX(P(0,5),MDL_MM,+1,+1*IC(5),W(1,9)) ! count 3
      CALL OXXXXX(P(0,5),MDL_MM,-1,+1*IC(5),W(1,10)) ! count 6
      CALL FFV1_2(W(1,3),W(1,1),GC_16,ZERO, FK_ZERO,W(1,11)) ! count 3
      CALL FFS2P1N_2(W(1,11), W(1,7), GC_62, TMP(1))
      call CombineAmp(2,
     & (/5,4/), 
     & (/9,10/),
     & TMP, W, AMP(1,1))
      CALL FFS2_0(W(1,11),W(1,10),W(1,8),GC_62,AMP(6,1)) ! count 1
      CALL VSS1_2(W(1,1),W(1,7),GC_15,MDL_MASSB, ZERO,W(1,13)) ! count 2
      CALL VSS1_2(W(1,1),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,14)) ! count 1
      CALL VSS1_2(W(1,2),W(1,7),GC_15,MDL_MASSB, ZERO,W(1,15)) ! count 2
      CALL VSS1_2(W(1,2),W(1,8),GC_15,MDL_MASSB, ZERO,W(1,16)) ! count 1
      CALL FFS2P1N_3(W(1,3), W(1,9), GC_62, TMP(1))
      call CombineAmpS(2, 
     &(/5,2/), 
     & (/13,15/), 
     & TMP, W, AMP(1,2))
      CALL FFS2P1N_3(W(1,3), W(1,10), GC_62, TMP(1))
      call CombineAmpS(4, 
     &(/4,6,1,3/), 
     & (/13,14,15,16/), 
